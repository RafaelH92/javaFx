...
public class SellerFormController implements Initializable {
    ...
    private Seller getFormData() {
        ...
        if (dpBirthDate.getValue() == null){
            ...
            Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault())); /* Pega a data do datePicker e converte para uma data do tipo instant (sem localidade) */
    ...
    private void setErrorMessages(Map<String, String> errors){
        ...
        /* utilizando operador condicinal ternario */
